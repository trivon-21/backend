...
const modelDefinitions = {
  ...
  SerializedAsset: { module: '../src/models/SerializedAsset', risk: 'high' },
...
const inventoryEndpoints = [
  ...
  endpoint('inventory', 'GET', '/list', 'Inventory list', true, 'inventory_manager.service.getInventoryList', ['Inventory', 'SerializedAsset', 'Supplier', 'User']),
  endpoint('inventory', 'GET', '/locations', 'Fixed storage-location catalog', true, 'inventory_manager.service.getInventoryLocations', []),
  endpoint('inventory', 'GET', '/item/:id', 'Inventory detail', true, 'inventory_manager.service.getInventoryItem', ['Inventory', 'SerializedAsset', 'Supplier', 'User']),
  ...
  endpoint('inventory', 'GET', '/asset-loans', 'Active asset loans', true, 'inventory_manager.service.getAssetLoans', ['AssetLoan', 'SerializedAsset', 'User']),
  endpoint('inventory', 'GET', '/available-tools', 'Available serialized tools', true, 'inventory_manager.service.getAvailableTools', ['Inventory', 'SerializedAsset', 'User']),
  endpoint('inventory', 'POST', '/asset-loans', 'Tool checkout', true, 'inventory_manager.service.checkOutTool', ['AssetLoan', 'SerializedAsset', 'Inventory', 'Activity', 'User']),
  endpoint('inventory', 'POST', '/asset-loans/return/:id', 'Tool return', true, 'inventory_manager.service.returnTool', ['AssetLoan', 'SerializedAsset', 'Activity', 'User']),
...
const collectionUsage = {
  ...
  procurements: {
    read: ['_id', 'receiptMode', 'orderRequestId', 'orderLineId', 'receiptAuthorizationId', 'receiptEventId', 'poNumber', 'supplierId', 'supplierName', 'inventoryId', 'itemName', 'sku', 'itemClass', 'subcategory', 'brand', 'quantity', 'acceptedQuantity', 'damagedQuantity', 'missingQuantity', 'unit', 'unitCost', 'totalCost', 'acceptedTotalCost', 'disputedTotalCost', 'condition', 'location', 'binLocation', 'receivedBy', 'receivedDate', 'sourceDocumentNumber', 'supportingDocumentUrl', 'nonPoReason', 'affectedWorkReference', 'discrepancyId', 'replacementForDiscrepancyId', 'damagedSerialNumbers', 'timestamp', 'createdAt'],
    filter: ['_id', 'receiptEventId'], sort: ['receivedDate', 'timestamp'], populate: ['supplierId', 'inventoryId'],
    write: ['receiptMode', 'orderRequestId', 'orderLineId', 'receiptAuthorizationId', 'receiptEventId', 'poNumber', 'supplierId', 'supplierName', 'inventoryId', 'itemName', 'sku', 'itemClass', 'subcategory', 'brand', 'quantity', 'acceptedQuantity', 'damagedQuantity', 'missingQuantity', 'unit', 'unitCost', 'totalCost', 'acceptedTotalCost', 'disputedTotalCost', 'condition', 'location', 'binLocation', 'receivedBy', 'receivedDate', 'sourceDocumentNumber', 'supportingDocumentUrl', 'nonPoReason', 'affectedWorkReference', 'discrepancyId', 'replacementForDiscrepancyId', 'damagedSerialNumbers'],
  },
  receipt_discrepancies: {
    read: ['_id', 'discrepancyId', 'receiptEventId', 'inventoryId', 'procurementId', 'supplierId', 'supplierName', 'itemName', 'sku', 'receiptMode', 'orderRequestId', 'orderLineId', 'receiptAuthorizationId', 'sourceDocumentNumber', 'expectedQuantity', 'acceptedQuantity', 'damagedQuantity', 'missingQuantity', 'outstandingQuantity', 'resolvedQuantity', 'unit', 'unitCost', 'disputedValue', 'acceptedSerialNumbers', 'damagedSerialNumbers', 'status', 'replacementProcurementIds', 'reportedById', 'reportedByName', 'resolvedAt', 'createdAt'],
    filter: ['_id', 'discrepancyId', 'receiptEventId', 'status'], sort: ['createdAt'],
    populate: ['inventoryId', 'supplierId', 'orderRequestId', 'receiptAuthorizationId', 'replacementProcurementIds'],
    write: ['discrepancyId', 'receiptEventId', 'inventoryId', 'procurementId', 'supplierId', 'supplierName', 'itemName', 'sku', 'receiptMode', 'orderRequestId', 'orderLineId', 'receiptAuthorizationId', 'sourceDocumentNumber', 'expectedQuantity', 'acceptedQuantity', 'damagedQuantity', 'missingQuantity', 'outstandingQuantity', 'resolvedQuantity', 'unit', 'unitCost', 'disputedValue', 'acceptedSerialNumbers', 'damagedSerialNumbers', 'status', 'replacementProcurementIds', 'reportedById', 'reportedByName', 'resolvedAt'],
  },
  dispatch_orders: {
  ...
  asset_loans: {
    read: ['_id', 'toolId', 'serializedAssetId', 'toolName', 'assetTag', 'normalizedAssetTag', 'technicianId', 'technicianUserId', 'technicianName', 'checkedOutAt', 'dueDate', 'returnedAt', 'condition', 'status', 'createdAt'],
    filter: ['_id', 'serializedAssetId', 'normalizedAssetTag', 'status'], sort: ['checkedOutAt', 'returnedAt'],
    write: ['toolId', 'serializedAssetId', 'toolName', 'assetTag', 'normalizedAssetTag', 'technicianId', 'technicianUserId', 'technicianName', 'checkedOutAt', 'dueDate', 'returnedAt', 'condition', 'status'],
  },
  serialized_assets: {
    read: ['_id', 'inventoryId', 'serialNumber', 'normalizedSerial', 'status', 'supplierId', 'procurementId', 'receiptDiscrepancyId', 'quarantineId', 'currentLoanId', 'activeRmaCaseId', 'preRmaStatus', 'receiptEventId', 'location', 'binLocation', 'origin', 'createdAt', 'updatedAt'],
    filter: ['_id', 'inventoryId', 'normalizedSerial', 'status'], sort: ['serialNumber'],
    populate: ['inventoryId', 'supplierId', 'procurementId', 'receiptDiscrepancyId', 'quarantineId', 'currentLoanId', 'activeRmaCaseId'],
    write: ['inventoryId', 'serialNumber', 'normalizedSerial', 'status', 'supplierId', 'procurementId', 'receiptDiscrepancyId', 'quarantineId', 'currentLoanId', 'activeRmaCaseId', 'preRmaStatus', 'receiptEventId', 'location', 'binLocation', 'origin'],
  },
  purchase_requests: {
  ...
  rma_cases: {
    read: ['_id', 'rmaId', 'serialNumber', 'inventoryId', 'serializedAssetId', 'itemName', 'itemSku', 'faultDescription', 'reportedBy', 'status', 'type', 'resolution', 'resolvedAt', 'createdAt'],
    filter: ['rmaId', 'serialNumber', 'serializedAssetId', 'status'], sort: ['createdAt'],
    write: ['rmaId', 'serialNumber', 'inventoryId', 'serializedAssetId', 'itemName', 'itemSku', 'faultDescription', 'reportedBy', 'status', 'type', 'resolution', 'resolvedAt'],
  },
  quarantine_items: {
    read: ['_id', 'quarantineId', 'itemName', 'quantity', 'unit', 'reason', 'location', 'source', 'sourceRefId', 'inventoryId', 'procurementId', 'supplierId', 'serialNumbers', 'status', 'disposedAt', 'disposedBy', 'createdAt'],
    filter: ['quarantineId', 'status'], sort: ['createdAt'],
    write: ['quarantineId', 'itemName', 'quantity', 'unit', 'reason', 'location', 'source', 'sourceRefId', 'inventoryId', 'procurementId', 'supplierId', 'serialNumbers', 'status', 'disposedAt', 'disposedBy'],
  },
  service_tickets: {
...
const frontendFields = [
  ...
  { collection: 'inventory', field: 'serialNumbers', classification: 'temporary-response-projection', note: 'Response compatibility field sourced from serialized_assets; legacy stored arrays await the registry migration.' },
  { collection: 'inventory', field: 'availableSerialNumbers', classification: 'derived', note: 'Calculated from serialized_assets rows whose status is available; never persisted.' },
